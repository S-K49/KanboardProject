...
public class EnvProperties {
    ...
    public static final void setupInstance(String instanceName) {
        switch (instanceName) {
            case "kanban1": {
                API_URL = propertyValue(PATH_TO_RESOURCE, PROPERTIES_FILE_NAME, "apiUrlKanban1");
                BASE_URL = propertyValue(PATH_TO_RESOURCE, PROPERTIES_FILE_NAME, "baseUrlKanban1");
                API_USERNAME = propertyValue(PATH_TO_RESOURCE, PROPERTIES_FILE_NAME, "username");
                API_TOKEN = propertyValue(PATH_TO_RESOURCE, PROPERTIES_FILE_NAME, "tokenKanban1");
                break;
            }
            default: {
